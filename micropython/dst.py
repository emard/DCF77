...
def is_dst(t:int):
  ...
  wd_end_october = (time.localtime(time.mktime((year,10,31,0,0,0,0,0,0)))[6]+1)%7
  dst_on  = time.mktime((year, 3,31-wd_end_march  ,1,0,0,0,0,0)) # last sunday of March, DST on
  dst_off = time.mktime((year,10,31-wd_end_october,0,0,0,0,0,0)) # last sunday of October, DST off
